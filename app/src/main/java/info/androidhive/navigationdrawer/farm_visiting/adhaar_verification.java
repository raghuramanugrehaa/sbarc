package info.androidhive.navigationdrawer.farm_visiting;
...
public class adhaar_verification extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adhaar_visit);
...
//                        break;
    ...
    public class HttpPostRequest extends AsyncTask<String, Void, String> {
        ...
        public HttpPostRequest(Map<String, String> postData) {
            dialog = new ProgressDialog(adhaar_verification.this);
            if (postData != null) {
        ...
        protected String doInBackground(String... params){
            String stringUrl = "http://54.68.72.28:3001/identity/EKYC/"+params[0];   //904617879924";
            String result = null;
            String inputLine;
            try {
        ...
        protected void onPostExecute(String result) {
            ...
            AlertDialog alertDialog = new AlertDialog.Builder(
                    adhaar_verification.this).create();
            if (result == null) {
                ...
                gatewayIntent = new Intent(adhaar_verification.this, ConsentActivity.class);
...
//                    response.setText(responseString);
                    Intent io=new Intent(adhaar_verification.this,declaration.class);
    ...
    public void showToast(String message) {
        Toast.makeText(adhaar_verification.this, message, Toast.LENGTH_LONG).show();
    }
