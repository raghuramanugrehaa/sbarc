...
import info.androidhive.navigationdrawer.fragment.open_video;

/**
 * Created by hp on 12-12-2017.
 */
public class support_open_video extends ArrayAdapter<String> {
    String[] Name;
    LayoutInflater inflater;
    Context c;
    private List<String> friendList;
    private List<String> searchList;
    public support_open_video(Context context, int resource, List<String> names, String namesk[],open_video fragk) {
...
//
            ...
            convertView = inflater.inflate(R.layout.support_open_video, null);
