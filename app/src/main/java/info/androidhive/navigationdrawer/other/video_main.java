 ...
 */
public class video_main extends ArrayAdapter<String> {
    String[] Name;
    LayoutInflater inflater;
    Context c;

    public video_main(Context context, int resource, List<String> names, String namesk[],MoviesFragment fragk) {
