...
import info.androidhive.navigationdrawer.farm_visiting.adhaar_verification;
...
if(isStoragePermissionGranted()) {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CAMERA_CAPTURE_IMAGE_REQUEST_CODE) {
            if (resultCode == RESULT_OK) {
                System.out.println("pty"+fileUri);
                // successfully captured the image

                Intent add_mem = new Intent(this, add_record.class);
                add_mem.putExtra("url",fileUri.toString());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_logout) {
            ...
            editor.clear();
            editor.commit();
            Intent IP=new Intent(MainActivity.this,login.class);
            startActivity(IP);
